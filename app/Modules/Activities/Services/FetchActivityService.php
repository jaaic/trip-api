...
class FetchActivityService
{
    ...
    public function getActivities(): array
    {
        ...
        $allActivities = $collection->getActivitiesByCityAndCountry($city, $country);

        $this->cheapestActivity = $collection->getCheapestActivityByCityAndCountry($city, $country);

        // check budget
        if ($this->cheapestActivity >= $this->totalBudget) {
        ...
        $cheapestBudget = $days * $this->cheapestActivity * Constants::MIN_ACTIVITIES_PER_DAY;
